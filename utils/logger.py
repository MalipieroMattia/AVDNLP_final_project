...
class WandbLogger:
    ...
    def __init__(self, config, run_name: Optional[str] = None, notes: Optional[str] = None):
    ...
    def log_loss_curves(self, train_losses: List[float], val_losses: List[float], 
                       epochs: Optional[List[int]] = None, step: Optional[int] = None):
    ...
    def log_metrics_plot(self, metrics_dict: Dict[str, List[float]], 
                        metric_name: str, step: Optional[int] = None):
    ...
    def log_learning_rate(self, learning_rates: List[float], 
                         steps: Optional[List[int]] = None, step: Optional[int] = None):
