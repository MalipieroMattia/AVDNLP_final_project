...
REPO_DIR="AVDNLP_final_project"  # Replace with your actual repo name
REPO_URL="https://github.com/MalipieroMattia/AVDNLP_final_project.git"  # Replace with your repo URL
